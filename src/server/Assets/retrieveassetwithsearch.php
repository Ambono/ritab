...
$siteSearchParam = mysqli_real_escape_string($conn, $data['siteSearch']);
...
$result = mysqli_query($conn,
    "SELECT DISTINCT il.Id, il.Name,
     ...
     left join videouploads vu on  vu.Useremail = pd.SellerEmail 
        where pd.Description like '%$siteSearchParam%' AND pd.Availuntil >= DATE_SUB(now(), INTERVAL 90 DAY)
